...
int setValueInNode(int val, int *pval,btreeNode *node, btreeNode **child) {
    ...
    if (val < node->val[1]) {
        ...
        if (val == node->val[pos]) {
            cout<<"Valor repetido! Já foi inserido na árvore\n";
            return 0;
        }
    }
    ...
    if (myNode) {
        ...
        if (flag) {
            if (myNode->link[pos - 1]) {
                ...
                if (flag == 0) {
                    cout<<"Valor não foi encontrado na árvore\n";
                }
            }
            else {
...
int main() {
    ...
    while (true) {
        ...
        case 1:
            ...
            break;
        case 2:
            cout<<"Digite um número para deletar: ";
            cin >> val;
            deletion(val, root);
            break;
        case 3:
            ...
            break;
        case 4:
            cout<<"Exibindo todos os elementos na árvore B: ";
            traversal(root);
            break;
        case 5:
